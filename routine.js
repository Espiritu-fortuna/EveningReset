(() => {
  ...
  const exercises = [
    ...
    },
    {
      ...
      manualEligible: true,
      segments: [
        count('Set 1', 10, 5, { announce: 'Dead bug. Set 1. Ten reps per side, alternating.', alternatingSides: true }),
        count('Set 2', 10, 5, { announce: 'Dead bug. Set 2. Ten reps per side, alternating.', alternatingSides: true }),
        count('Set 3', 10, 5, { announce: 'Dead bug. Set 3. Ten reps per side, alternating.', alternatingSides: true })
      ]
    },
    {
