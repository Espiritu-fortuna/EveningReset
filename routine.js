(() => {
  ...
  const exercises = [
    ...
    },
    {
      ...
      manualEligible: true,
      segments: [
        count('Set 1', 10, 5, { announce: 'Dead Bug', alternatingSides: true }),
        count('Set 2', 10, 5, { announce: 'Dead Bug', alternatingSides: true }),
        count('Set 3', 10, 5, { announce: 'Dead Bug', alternatingSides: true })
      ]
    },
    {
